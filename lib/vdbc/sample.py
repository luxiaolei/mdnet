...
def gaussian_sample(im, bbox, params, num, stype):
    ...
    Args:
        ...
        params: tuple length 5, (offsetx, offsety, scalefactor, pos_overlap, neg_overlap)
        num: int, Number of samples
        stype: string, either 'TRAIN' or 'TEST', specifies phase

    Returns:
        bboxes: list of length num, with each element is a dict, with 
            {img: np.ndarray 
            box: list of length 4
            label: int, {0,1}
            overlap: float [0,1]
            }
    """
